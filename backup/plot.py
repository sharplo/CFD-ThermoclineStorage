...
Plot_Line("err_L1.dat")
Plot_LineSlope("err_L1.dat")
Plot_Line("err_L2.dat")
Plot_LineSlope("err_L2.dat")
Plot_Line("err_inf.dat")
Plot_LineSlope("err_inf.dat")
Plot_Line("err_inf_loc.dat")
